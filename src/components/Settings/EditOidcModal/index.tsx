...
const messages = defineMessages('settings.settings.SettingsOidc', {
  ...
  toastTestSuccess: 'OpenID Connect provider configuration is valid!',
  toastTestFailed: 'Failed to connect to OpenID Connect provider.',
});
...
function SlugField(props: FieldAttributes<unknown> & { readOnly?: boolean }) {
  ...
  useEffect(() => {
    if (!props.readOnly)
      setFieldValue(props.name, name?.toLowerCase().trim().replace(/\s/g, '-'));
                ...
                <div className="form-input-area">
                  <div className="flex items-center gap-2">
                    ...
                    <Button
                      buttonType="warning"
                      disabled={
                        isTesting || !values.issuerUrl || !!errors.issuerUrl
                      }
                      onClick={(e) => {
                        e.preventDefault();
                        testSettings();
                      ...
                      <div className="form-row mt-0">
                        ...
                        <div className="form-input-area">
                          <SlugField
                            ...
                            className={
                              props.provider != null ? 'opacity-50' : ''
                            }
                          />
                          {errors.slug &&
                            touched.slug &&
